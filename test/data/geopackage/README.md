...
## example_v4_0_extra_col.gpkg

Minimal synthetic v4.0 GeoPackage with auxiliary tables carrying extra/unusual
columns. Used by the extra-column tolerance regression tests.
Generated by `make_v4_0_extra_col_fixture.py`.
...
The five v2.2 / v4.0 `.gpkg` files in this directory are committed
...
python3 make_v4_0_minimal_fixture.py    # → example_v4_0_minimal.gpkg
python3 make_v4_0_dangling_fixture.py   # → example_v4_0_dangling.gpkg
python3 make_v4_0_extra_col_fixture.py  # → example_v4_0_extra_col.gpkg
```
...
```
python3 diff_fixture.py example_v4_0.gpkg
```
