...
def main():
    ...
    cur.execute(
        ...
        " ('nexus','features','nexus','','2026-01-01 00:00:00',-82.0,29.0,-80.0,31.0,4326)"
    )
    cur.execute(
    ...
    cur.execute(
        "INSERT INTO gpkg_contents VALUES"
        " ('divides','features','divides','','2026-01-01 00:00:00',-82.0,29.0,-80.0,31.0,4326)"
    )
    cur.execute(
    ...
    cur.execute(
        "INSERT INTO gpkg_contents VALUES"
        " ('flowpaths','features','flowpaths','','2026-01-01 00:00:00',-81.5,29.5,-80.0,30.5,4326)"
    )
    cur.execute(
