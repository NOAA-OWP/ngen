#!/usr/bin/env python3
"""
Generate example_v4_0beta1_minimal.gpkg — a subset-tolerance v4.0beta1 GeoPackage used by
...
Topology (3 catchments, 2 nexuses) — identical to example_v4_0beta1.gpkg:
...
Usage:
    python3 make_v4_0beta1_minimal_fixture.py

Output: example_v4_0beta1_minimal.gpkg (sibling of this script).
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "example_v4_0beta1_minimal.gpkg")
SRS_ID = 4326
...
def main():
    ...
    # ── flowpaths (v4.0beta1 schema, minimal columns) ─────────────────────────────
    cur.execute("""
