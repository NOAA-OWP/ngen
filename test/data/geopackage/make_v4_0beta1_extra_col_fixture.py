#!/usr/bin/env python3
"""
Generate example_v4_0beta1_extra_col.gpkg — a minimal v4.0beta1 GeoPackage used by the
...
Usage:
    python3 make_v4_0beta1_extra_col_fixture.py

Output: example_v4_0beta1_extra_col.gpkg (sibling of this script).
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "example_v4_0beta1_extra_col.gpkg")
SRS_ID = 4326
...
def main():
    ...
    # flowpaths (needed for v4.0beta1 toid synthesis JOIN)
    cur.execute("""
