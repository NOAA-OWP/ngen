...
detect_version, nexus-remap, toid-synthesis, and v4.0 regression tests.
...
def main():
    ...
    # ── nexus (v4.0 schema) ───────────────────────────────────────────────────
    # nexus_id column (not 'id') is the v4.0 signature detected by detect_version.
