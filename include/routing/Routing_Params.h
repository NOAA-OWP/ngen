...
struct routing_params
{
     ...
     */
    routing_params() : t_route_connection_path(""), t_route_config_file_with_path(""), input_path("") {}
     ...
     * @param input_path
     */
    routing_params(std::string t_route_connection_path, std::string t_route_config_file_with_path, 
        std::string input_path):
        t_route_connection_path(t_route_connection_path), 
        t_route_config_file_with_path(t_route_config_file_with_path), input_path(input_path)
        {
        }
